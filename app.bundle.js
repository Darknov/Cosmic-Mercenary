...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"DemoScene\", function() { return DemoScene; });\n/* harmony import */ var _entities_Player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../entities/Player */ \"./src/entities/Player.js\");\n/* harmony import */ var _entities_GenericEnemy__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../entities/GenericEnemy */ \"./src/entities/GenericEnemy.js\");\n/* harmony import */ var _loadingBar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./loadingBar */ \"./src/scenes/loadingBar.js\");\n/* harmony import */ var _libraries_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../libraries/utils */ \"./src/libraries/utils.js\");\n/* harmony import */ var _sceneAssets_demoSceneAssets__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sceneAssets/demoSceneAssets */ \"./src/scenes/sceneAssets/demoSceneAssets.js\");\n/* harmony import */ var _sceneAssets_loadAssets__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sceneAssets/loadAssets */ \"./src/scenes/sceneAssets/loadAssets.js\");\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\n\n\n\n\n\n\nvar width = 3000;\nvar height = 3000;\nvar DemoScene =\n/*#__PURE__*/\nfunction (_Phaser$Scene) {\n  _inherits(DemoScene, _Phaser$Scene);\n\n  function DemoScene(config) {\n    _classCallCheck(this, DemoScene);\n\n    return _possibleConstructorReturn(this, _getPrototypeOf(DemoScene).call(this, _objectSpread({}, config, {\n      key: 'DemoScene'\n    })));\n  }\n\n  _createClass(DemoScene, [{\n    key: \"preload\",\n    value: function preload() {\n      Object(_loadingBar__WEBPACK_IMPORTED_MODULE_2__[\"addLoadingBar\"])(this);\n      Object(_sceneAssets_loadAssets__WEBPACK_IMPORTED_MODULE_5__[\"loadAssets\"])(this, _sceneAssets_demoSceneAssets__WEBPACK_IMPORTED_MODULE_4__[\"demoSceneAssets\"]);\n    }\n  }, {\n    key: \"create\",\n    value: function create() {\n      this.gameObjects = this.add.group({\n        runChildUpdate: true\n      });\n      this.physics.world.setBounds(-width / 2, -height / 2, width, height);\n      this.cameras.main.setBounds(-width / 2, -height / 2, width, height);\n      setBackground(this);\n      populate(this);\n    }\n  }, {\n    key: \"update\",\n    value: function update(time, delta) {}\n  }]);\n\n  return DemoScene;\n}(Phaser.Scene);\n\nvar populate = function populate(scene) {\n  scene.player = new _entities_Player__WEBPACK_IMPORTED_MODULE_0__[\"Player\"]({\n    scene: scene,\n    x: 0,\n    y: 0\n  });\n  new _entities_GenericEnemy__WEBPACK_IMPORTED_MODULE_1__[\"GenericEnemy\"]({\n    scene: scene,\n    x: 100,\n    y: 100\n  });\n  scene.cameras.main.startFollow(scene.player);\n}; // background tests, looks byatiful\n\n\nvar setBackground = function setBackground(scene) {\n  scene.background = scene.add.tileSprite(0, 0, width, height, 'background');\n  var nebula = scene.add.image(0, 0, 'el' + Object(_libraries_utils__WEBPACK_IMPORTED_MODULE_3__[\"getRandomInt\"])(7, 11));\n  nebula.setDisplaySize(width, height);\n  nebula.width = width;\n  nebula.height = height;\n\n  for (var i = 0; i < 15; i++) {\n    var el = scene.add.image(Object(_libraries_utils__WEBPACK_IMPORTED_MODULE_3__[\"getRandomInt\"])(-width / 2, width / 2), Object(_libraries_utils__WEBPACK_IMPORTED_MODULE_3__[\"getRandomInt\"])(-width / 2, width / 2), 'el' + Object(_libraries_utils__WEBPACK_IMPORTED_MODULE_3__[\"getRandomInt\"])(1, 7));\n    el.setAngle(Object(_libraries_utils__WEBPACK_IMPORTED_MODULE_3__[\"getRandomInt\"])(0, 180));\n    el.scale = Math.random();\n  }\n};\n\n//# sourceURL=webpack:///./src/scenes/demoScene.js?");
